...
def main() -> None:
    ...
    st.markdown("*AI-powered platform for iterative PRD and Technical Specification generation*")
    ...
    with col2:
        ...
        st.selectbox("Framework", ["Vanilla OpenAI", "Vanilla Google", "CrewAI"], disabled=True)
